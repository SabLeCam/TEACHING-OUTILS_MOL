...
Le séquençage complet du génome de *_Daphnia pulex_* a révélé une deuxième forme de la lactate désydrogénase : *la B*. Ce gène est vraisemblablement apparu par duplication et nous ne connaissons pas sa fonction. Il est possible qu’il s’agisse d’un pseudogène. Les pseudogènes sont d'anciens gènes qui n'ont plus leur fonction d'origine. Les mutations sont plus susceptibles de s’accumuler sur les pseudogènes puisqu’ils ne sont pas sous sélection pour maintenir une fonction précise dans le génome. Ils sont alors libres d’accumuler plus de mutations. 
...
>. 4.Quelle espèce possède le plus grand niveau de polymorphisme nucléotidique pour la LDHA et pour la LDHB ?
...
>7. Quelle type de sélection agit sur chacun des gènes ? Expliquer votre réponse en fonction des indices de pS et de Tajima.
>8. Peut-on affirmer que le LDHB est un pseudogène ?
...
Rapporter l'indice pS ainsi que le D de Tajima pour les LDHA et LDHB. Rapporter cette statistique pour les X et les C séparément.
